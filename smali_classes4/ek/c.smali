...
.method public final b(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)V
    ...
    invoke-virtual {p2}, Lhk/b;->b()[I

    move-result-object v0

    invoke-static {v0}, Luk/e;->d([I)Z
    ...
    invoke-virtual {p2}, Lhk/b;->l()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p2}, Lhk/b;->i()Ljava/lang/String;
...
.method public c(Lfk/e;Lcom/faceunity/core/avatar/model/Avatar;)V
    .locals 8
    ...
    invoke-static {v2}, Lik/c;->g(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Lhk/b;->x(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lhk/b;->n([I)V
    ...
    invoke-direct {v2, v3, v4, v5, v1}, Lhk/a;-><init>(Ljava/lang/String;III)V
    ...
    invoke-direct {v1, v2, v3, v4, v0}, Lhk/a;-><init>(Ljava/lang/String;III)V
...
.method public d(Lfk/e;)Ljava/lang/String;
    .locals 3
    ...
    invoke-virtual {p0, v1}, Lek/c;->f(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    invoke-virtual {p0, p1}, Lek/c;->e(Ljava/util/Map;)Lorg/json/JSONObject;
...
.method public final f(Ljava/util/List;)Lorg/json/JSONArray;
    ...
    invoke-virtual {v0}, Lhk/b;->i()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lhk/b;->l()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v2, v3}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    invoke-virtual {v0}, Lhk/b;->b()[I

    move-result-object v2

    invoke-static {v2}, Luk/e;->d([I)Z
...
.method public final g(Ljava/lang/String;Lorg/json/JSONArray;Z)Ljava/util/List;
    ...
    :cond_0
    invoke-virtual {p0, p1, v2, p3}, Lek/c;->l(Ljava/lang/String;Lorg/json/JSONObject;Z)Lhk/b;
...
.method public final h(Lorg/json/JSONObject;ZLfk/e;)V
    .locals 2
    ...
    invoke-virtual {p3, v0}, Lfk/e;->h(I)V
    ...
    invoke-virtual {p3}, Lfk/e;->d()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v0, p2}, Lek/c;->g(Ljava/lang/String;Lorg/json/JSONArray;Z)Ljava/util/List;

    move-result-object p2

    invoke-virtual {p3, p2}, Lfk/e;->g(Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1}, Lek/c;->k(Lorg/json/JSONObject;)Ljava/util/Map;

    move-result-object p0

    invoke-virtual {p3, p0}, Lfk/e;->f(Ljava/util/Map;)V

    :cond_2
    return-void
.end method

.method public i(Ljava/lang/String;Lcom/faceunity/core/avatar/model/Avatar;Lfk/e;)V
    .locals 3

    sget-object v0, Lek/c;->a:Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p1}, Lvk/b;->e(Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-virtual {p0, p1, v0, p3}, Lek/c;->h(Lorg/json/JSONObject;ZLfk/e;)V

    invoke-virtual {p3}, Lfk/e;->b()Ljava/util/List;

    move-result-object p1

    invoke-virtual {p0, p2, p1}, Lek/c;->b(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/List;)V

    invoke-virtual {p3}, Lfk/e;->a()Ljava/util/Map;

    move-result-object p1

    invoke-virtual {p0, p2, p1}, Lek/c;->a(Lcom/faceunity/core/avatar/model/Avatar;Ljava/util/Map;)V
    :try_end_0
    ...
    sget-object p1, Lek/c;->a:Ljava/lang/String;
...
.method public j(Ljava/lang/String;Lfk/e;)V
    .locals 3
    ...
    invoke-virtual {p0, p1, v0, p2}, Lek/c;->h(Lorg/json/JSONObject;ZLfk/e;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final k(Lorg/json/JSONObject;)Ljava/util/Map;
    ...
    invoke-virtual {p0, v2, v3}, Lek/c;->m(Ljava/lang/String;Lorg/json/JSONObject;)Lhk/a;
...
.method public final l(Ljava/lang/String;Lorg/json/JSONObject;Z)Lhk/b;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lhk/b;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lik/c;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {v0, p3}, Lhk/b;->x(Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    invoke-virtual {v0, p0}, Lhk/b;->x(Ljava/lang/String;)V
    ...
    sget-object v1, Ldk/a;->a:Ljava/lang/String;
    ...
    invoke-static {p2, p0}, Luk/g;->c(Lorg/json/JSONObject;Ljava/lang/String;)[I

    move-result-object p0

    invoke-virtual {v0, p0}, Lhk/b;->n([I)V

    :cond_3
    return-object v0
.end method

.method public final m(Ljava/lang/String;Lorg/json/JSONObject;)Lhk/a;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, Lhk/a;-><init>(Ljava/lang/String;IIIF)V
