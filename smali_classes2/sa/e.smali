...
.method public constructor <init>(Ljava/lang/String;Landroid/text/TextPaint;Landroid/graphics/Paint$FontMetricsInt;II)V
    ...
    iput-object p2, p0, Lsa/e;->b:Landroid/text/TextPaint;

    iput-object p3, p0, Lsa/e;->c:Landroid/graphics/Paint$FontMetricsInt;
...
.method public static a(FII)Landroid/text/TextPaint;
    ...
    invoke-static {}, Lcom/android/camera/z5;->x1()Landroid/graphics/Typeface;
...
.method public static b(Ljava/lang/String;FII)Lsa/e;
    .locals 1
    ...
    invoke-static {p1}, Lsa/a;->g(F)Landroid/text/TextPaint;
    ...
    :cond_0
    invoke-static {p1, p2, p3}, Lsa/e;->a(FII)Landroid/text/TextPaint;

    move-result-object p1

    :goto_0
    invoke-static {p0, p1, p3}, Lsa/e;->c(Ljava/lang/String;Landroid/text/TextPaint;I)Lsa/e;
...
.method public static c(Ljava/lang/String;Landroid/text/TextPaint;I)Lsa/e;
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lsa/e;-><init>(Ljava/lang/String;Landroid/text/TextPaint;Landroid/graphics/Paint$FontMetricsInt;II)V
...
.method public onDraw(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
    ...
    iget-object p2, p0, Lsa/e;->c:Landroid/graphics/Paint$FontMetricsInt;
    ...
    iget-object p2, p0, Lsa/e;->a:Ljava/lang/String;

    iget-object p0, p0, Lsa/e;->b:Landroid/text/TextPaint;
