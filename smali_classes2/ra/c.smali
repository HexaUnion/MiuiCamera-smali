...
.method public static c(ZI[I[FLandroid/graphics/Rect;IIII)Landroid/graphics/Rect;
    ...
    invoke-static/range {v0 .. v8}, Lra/c;->a([II[I[FLandroid/graphics/Rect;IIII)V
    ...
    invoke-static {v12}, Lp3/c2;->g([I)Landroid/graphics/Rect;
...
.method public static d(Lcom/android/camera/effect/renders/b0;Lt3/g;Lcom/android/camera/effect/renders/f;)Lcom/android/camera/effect/renders/b0;
    .locals 13

    iget-boolean v0, p1, Lt3/g;->R:Z

    const/4 v1, 0x0

    if-nez v0, :cond_0

    iget-boolean v0, p1, Lt3/g;->S:Z
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/b0;->a()Lcom/android/camera/effect/renders/c;
    ...
    invoke-direct/range {v2 .. v9}, Lta/a;-><init>(IIILjava/lang/String;ZIZ)V

    goto :goto_1

    :cond_3
    iget-boolean p0, p1, Lt3/g;->S:Z
    ...
    iget p0, p1, Lt3/g;->H:I

    invoke-static {v0, v10, p0, p2}, Lsa/f;->n(IIILcom/android/camera/effect/renders/f;)Lcom/android/camera/effect/renders/b0;
    ...
    invoke-static {v0, v10, p0, p2}, Lsa/f;->m(IIILcom/android/camera/effect/renders/f;)Lcom/android/camera/effect/renders/b0;
    ...
    invoke-virtual {v1, v11}, Lcom/android/camera/effect/renders/b0;->n(Lcom/android/camera/effect/renders/c;)V

    :cond_7
    return-object v1
.end method

.method public static e(Lcom/android/camera/effect/renders/b0;Lt3/q;)Lcom/android/camera/effect/renders/b0;
    .locals 13

    iget-boolean v0, p1, Lt3/q;->P:Z

    const/4 v1, 0x0

    if-nez v0, :cond_0

    iget-boolean v0, p1, Lt3/q;->Q:Z
    ...
    :cond_0
    iget-object v0, p1, Lt3/q;->R:Lcom/android/camera/effect/renders/f;
    ...
    iget-object v3, p1, Lt3/q;->x:Landroid/util/Size;

    invoke-virtual {v3}, Landroid/util/Size;->getHeight()I

    move-result v3

    invoke-virtual {p1}, Lt3/q;->e()Z
    ...
    iget-boolean v1, p1, Lt3/q;->Q:Z

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean p1, p1, Lt3/q;->P:Z
    ...
    iget-boolean v6, p1, Lt3/q;->Q:Z

    invoke-virtual {p0, v6}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    invoke-virtual {p0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-boolean v4, p1, Lt3/q;->P:Z
    ...
    iget p0, p1, Lt3/q;->J:I

    invoke-static {v2, v11, p0, v0}, Lsa/f;->n(IIILcom/android/camera/effect/renders/f;)Lcom/android/camera/effect/renders/b0;
    ...
    invoke-static {v2, v11, p0, v0}, Lsa/f;->m(IIILcom/android/camera/effect/renders/f;)Lcom/android/camera/effect/renders/b0;
    ...
    invoke-virtual {v1, v12}, Lcom/android/camera/effect/renders/b0;->n(Lcom/android/camera/effect/renders/c;)V
...
.method public static f([I[FLandroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-static {v1}, Lp3/c2;->g([I)Landroid/graphics/Rect;
...
.method public static g(Lcom/android/camera/effect/renders/b0;Lt3/g;Lcom/android/camera/effect/renders/f;)Lcom/android/camera/effect/renders/b0;
    .locals 13

    iget-object v8, p1, Lt3/g;->Q:Ljava/lang/String;
    ...
    invoke-direct/range {v0 .. v6}, Lta/b;-><init>(Ljava/lang/String;IIIZZ)V
    ...
    iget-object p1, p1, Lt3/g;->T:Lcom/android/camera/effect/renders/f;
    ...
    invoke-direct/range {v0 .. v5}, Lsa/d;-><init>(Ljava/lang/String;IIIZ)V

    :goto_1
    invoke-virtual {p0, v11}, Lcom/android/camera/effect/renders/b0;->n(Lcom/android/camera/effect/renders/c;)V

    return-object p0
.end method

.method public static h(Lcom/android/camera/effect/renders/b0;Lt3/q;)Lcom/android/camera/effect/renders/b0;
    .locals 13

    iget-object v1, p1, Lt3/q;->O:Ljava/lang/String;
    ...
    iget-object v7, p1, Lt3/q;->O:Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p0, v12}, Lcom/android/camera/effect/renders/b0;->n(Lcom/android/camera/effect/renders/c;)V
...
.method public static n(Lcom/android/camera/effect/renders/b0;)[B
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/b0;->i()Lcom/android/gallery3d/ui/b;

    move-result-object p0

    check-cast p0, Lcom/android/gallery3d/ui/r;

    sget-object v0, Landroid/graphics/Bitmap$CompressFormat;->PNG:Landroid/graphics/Bitmap$CompressFormat;

    invoke-virtual {p0, v0}, Lcom/android/gallery3d/ui/r;->getBitmapData(Landroid/graphics/Bitmap$CompressFormat;)[B
...
.method public static o(Lcom/android/camera/effect/renders/b0;F)[I
    .locals 3
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/b0;->f()I
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/b0;->g()I
...
.method public static p(IIILcom/android/camera/effect/renders/b0;Lcom/android/camera/effect/renders/b0;)Landroid/graphics/Rect;
    .locals 14
    ...
    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/b0;->l()Z

    move-result v10

    new-array v11, v7, [I

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/b0;->k()I

    move-result v12

    aput v12, v11, v8

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/b0;->d()I

    move-result v12

    aput v12, v11, v6

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/b0;->f()I

    move-result v12

    aput v12, v11, v5

    invoke-virtual/range {p3 .. p3}, Lcom/android/camera/effect/renders/b0;->g()I
    ...
    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/b0;->l()Z

    move-result v9

    new-array v7, v7, [I

    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/b0;->k()I

    move-result v10

    aput v10, v7, v8

    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/b0;->d()I

    move-result v10

    aput v10, v7, v6

    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/b0;->f()I

    move-result v6

    aput v6, v7, v5

    invoke-virtual/range {p4 .. p4}, Lcom/android/camera/effect/renders/b0;->g()I
    ...
    invoke-static/range {v0 .. v5}, Lra/c;->q(III[I[IZ)Landroid/graphics/Rect;
...
.method public static q(III[I[IZ)Landroid/graphics/Rect;
    ...
    invoke-static {v1, p0, p1}, Lra/c;->b([III)V
