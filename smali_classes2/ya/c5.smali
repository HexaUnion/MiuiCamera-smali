...
.method public constructor <init>(Lya/c4;ILandroid/view/Surface;)V
    ...
    iput-boolean p1, p0, Lya/c5;->I:Z

    iput p2, p0, Lya/c5;->L:I

    sget-object p1, Lfm/c;->j:Lfm/c;

    iput-object p1, p0, Lya/c5;->O:Lfm/c;

    iput-object p3, p0, Lya/c5;->P:Landroid/view/Surface;
...
.method public static synthetic d0(Lya/c5;)I
    .locals 0

    iget p0, p0, Lya/c5;->N:I

    return p0
.end method

.method public static synthetic e0(Lya/c5;)I
    .locals 2

    iget v0, p0, Lya/c5;->N:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lya/c5;->N:I

    return v0
.end method

.method public static synthetic f0(Lya/c5;)Lfm/c;
    .locals 0

    iget-object p0, p0, Lya/c5;->O:Lfm/c;

    return-object p0
.end method

.method public static synthetic g0(Lya/c5;)Landroid/hardware/camera2/CaptureResult;
    .locals 0

    iget-object p0, p0, Lya/c5;->H:Landroid/hardware/camera2/CaptureResult;

    return-object p0
.end method

.method public static synthetic h0(Lya/c5;Landroid/hardware/camera2/CaptureResult;)Landroid/hardware/camera2/CaptureResult;
    .locals 0

    iput-object p1, p0, Lya/c5;->H:Landroid/hardware/camera2/CaptureResult;

    return-object p1
.end method

.method public static synthetic i0(Lya/c5;ZI)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lya/c5;->l0(ZI)V

    return-void
.end method

.method public static synthetic j0(Lya/c5;)I
    .locals 0

    iget p0, p0, Lya/c5;->K:I
...
.method public H()V
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0}, Lya/c5;->c()Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;

    move-result-object v1

    invoke-virtual {p0}, Lya/c5;->f()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v2

    iget-object v3, p0, Lya/c5;->P:Landroid/view/Surface;
    ...
    iput-object v2, p0, Lya/x4;->D:Ljava/lang/String;
...
.method public c()Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;
    ...
    new-instance v0, Lya/c5$a;

    invoke-direct {v0, p0}, Lya/c5$a;-><init>(Lya/c5;)V
...
.method public f()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-static {v0}, Lya/g;->v2(Lya/f;)Z
    ...
    invoke-virtual {v4}, Lya/j5;->G()Landroid/util/SparseArray;

    move-result-object v4

    invoke-static {v4}, Lhb/e;->d(Landroid/util/SparseArray;)Ljava/util/List;
    ...
    invoke-virtual {v4, v7, v8}, Lya/j5;->E(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v7, v4, v1}, Lya/x4;->P(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v4, v0, v6}, Lya/c4;->a3(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    invoke-virtual {v4, v3}, Lya/c3;->i4(Z)Z
    ...
    invoke-static {v0, v6, v1, v4}, Lya/i3;->Y(Landroid/hardware/camera2/CaptureRequest$Builder;ILya/f;Lya/c3;)V

    new-instance v4, Lcom/android/camera/fragment/beauty/a0;

    invoke-direct {v4}, Lcom/android/camera/fragment/beauty/a0;-><init>()V

    const-string v5, "i:0"

    iput-object v5, v4, Lcom/android/camera/fragment/beauty/a0;->a:Ljava/lang/String;

    invoke-static {v1}, Lya/g;->v(Lya/f;)Ljava/util/HashSet;

    move-result-object v5

    invoke-static {v0, v5, v4}, Lcom/android/camera2/compat/MiCameraCompat;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/a0;)V
    ...
    invoke-static {v4}, Lya/g;->v2(Lya/f;)Z
    ...
    invoke-static {v0, v1, v3}, Lya/i3;->q1(Landroid/hardware/camera2/CaptureRequest$Builder;Lya/f;Z)V

    invoke-static {v0, v1, v3}, Lya/i3;->f1(Landroid/hardware/camera2/CaptureRequest$Builder;Lya/f;Z)V
...
.method public bridge synthetic u(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lya/c5;->k0([B)V
