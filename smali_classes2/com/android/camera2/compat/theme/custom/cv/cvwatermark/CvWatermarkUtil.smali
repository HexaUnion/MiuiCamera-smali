...
.method private static buildExif(Lkd/e;Landroid/hardware/camera2/CaptureResult;IILcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lkd/e;
    .locals 11

    if-nez p0, :cond_0

    invoke-static {}, Lkd/d;->e()Lkd/e;
    ...
    invoke-static/range {v0 .. v10}, Lcom/android/camera/f3;->d(IIIJLandroid/location/Location;Landroid/hardware/camera2/CaptureResult;JLkd/e;Z)V
    ...
    invoke-static {p0, p2, p3, v0, p4}, Lcom/android/camera/f3;->a(Lkd/e;JIS)V

    invoke-static {p1, p0}, Lcom/android/camera/f3;->c(Landroid/hardware/camera2/CaptureResult;Lkd/e;)V

    invoke-static {p0}, Lcom/android/camera/f3;->o(Lkd/e;)V
    :try_end_0
...
.method private static composeXmpMeta(Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Ld/g;
    ...
    invoke-static {v0, v2, v3, v4, p0}, Lcom/android/camera/g6;->a(Lorg/xmlpull/v1/XmlSerializer;ILandroid/graphics/Rect;ZZ)V
    ...
    invoke-interface {v0, v1, v2, p0}, Ld/g;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static dumpYuv(Ljava/lang/String;Ljava/lang/String;[BII)V
    ...
    invoke-static {p2, v3}, Lcom/android/camera/z5;->k4([BLjava/lang/String;)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/z5;->k4([BLjava/lang/String;)V
...
.method private static exifToArray(Lkd/e;[B)[B
    .locals 6
    ...
    :try_start_1
    invoke-virtual {p0, v2, p1}, Lkd/e;->w(Ljava/io/OutputStream;[B)Ljava/io/OutputStream;
    ...
    invoke-virtual {p1}, Lkd/g;->e()V

    move-object p1, p0

    check-cast p1, Lkd/g;

    invoke-virtual {p1}, Lkd/g;->g()V
...
.method public static processPreviewWatermark(Lwe/w;)V
    .locals 6
    ...
    invoke-virtual {v4}, Lwe/x;->k0()Landroid/location/Location;
    ...
    invoke-virtual {p0}, Lwe/w;->q()I

    move-result v4

    invoke-virtual {v3, v4}, Lid/b;->w8(I)Z
    ...
    invoke-static {v1, v0, v2}, Lcom/android/camera/z5;->C0(Landroid/graphics/Bitmap;[BI)[B
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/e3;->b(Z)I
    ...
    invoke-virtual {v2, v3, v1}, Lwe/x;->W0(II)V

    invoke-virtual {p0, v0}, Lwe/w;->r0([B)V

    return-void
.end method

.method public static processWatermark(Lwe/w;)V
    .locals 26

    invoke-virtual/range {p0 .. p0}, Lwe/w;->s()Lwe/x;
    ...
    invoke-virtual {v2}, Lwe/x;->g0()I

    move-result v2

    invoke-virtual/range {p0 .. p0}, Lwe/w;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual/range {p0 .. p0}, Lwe/w;->i()I
    ...
    invoke-virtual {v9}, Lwe/x;->k0()Landroid/location/Location;
    ...
    invoke-virtual/range {p0 .. p0}, Lwe/w;->q()I

    move-result v11

    invoke-virtual {v10, v11}, Lid/b;->w8(I)Z
    ...
    invoke-virtual {v12}, Lwe/x;->r0()Landroid/util/Size;
    ...
    invoke-virtual/range {p0 .. p0}, Lwe/w;->x()[B

    move-result-object v13

    invoke-virtual/range {p0 .. p0}, Lwe/w;->w()Ljava/lang/String;
    ...
    invoke-virtual {v11}, Lwe/x;->p0()Landroid/util/Size;
    ...
    invoke-virtual/range {p0 .. p0}, Lwe/w;->t()J
    ...
    invoke-virtual {v2, v4, v5}, Lwe/x;->T0(ILandroid/graphics/Rect;)V
    ...
    invoke-static {v9, v8, v4, v5, v0}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->buildExif(Lkd/e;Landroid/hardware/camera2/CaptureResult;IILcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lkd/e;
    ...
    invoke-virtual {v4, v0}, Lkd/e;->M0(Ld/g;)V

    move-object/from16 v10, v25

    invoke-static {v4, v10}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->exifToArray(Lkd/e;[B)[B
    ...
    invoke-static/range {v1 .. v6}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->saveHeifFile(Lwe/w;[B[BIII)[B
    ...
    invoke-static {v6}, Lkd/d;->k([B)Lkd/e;
    ...
    invoke-static {v1, v8, v5, v9, v0}, Lcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkUtil;->buildExif(Lkd/e;Landroid/hardware/camera2/CaptureResult;IILcom/android/camera2/compat/theme/custom/cv/cvwatermark/CvWatermarkParam;)Lkd/e;

    invoke-static {v6, v1, v10}, Lkd/d;->H([BLkd/e;[B)[B
    ...
    :cond_b
    invoke-virtual/range {p0 .. p0}, Lwe/w;->A()I
    ...
    :try_start_2
    invoke-static {v1, v2, v0}, Lcom/android/camera/f6;->f(Ljava/io/InputStream;Ljava/io/OutputStream;Ld/g;)Z
    ...
    invoke-virtual {v1, v0}, Lwe/w;->r0([B)V

    return-void
.end method

.method private static saveHeifFile(Lwe/w;[B[BIII)[B
    .locals 10
    ...
    invoke-virtual {p0}, Lwe/w;->L()Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v5}, Lcom/android/camera/z5;->c1(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p3, p4}, Lid/b;->w8(I)Z
    ...
    invoke-virtual {p0, p3, p4}, Lmb/d;->m(J)V
    ...
    invoke-static {p0}, Loi/b;->h(Ljava/lang/String;)[B
