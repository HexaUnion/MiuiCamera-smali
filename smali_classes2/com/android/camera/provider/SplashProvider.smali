...
# static fields
.field public static final d:Ljava/lang/String; = "SplashProvider"

.field public static final e:Ljava/lang/String; = ".jpg"

.field public static final f:Ljava/lang/String; = "splash"

.field public static final g:Ljava/lang/String; = "splashVertical"

.field public static final h:Ljava/lang/String; = "splashHorizontal"

.field public static final i:Ljava/lang/String; = "splashBookBack"

.field public static final j:Ljava/lang/String; = "splashBookFront"

.field public static final k:Ljava/lang/String; = "splashGalleryHorizontal"

.field public static final l:Ljava/lang/String; = "splashLaptopHorizontal"

.field public static final m:J = 0xbb8L

.field public static final n:Ljava/lang/String; = "getCameraSplash"

.field public static final o:F = 0.7f

.field public static final p:F = 0.88355f
...
.method public static synthetic a(Lcom/android/camera/provider/SplashProvider;Landroid/content/Context;Lcom/android/camera/display/layout/CamLayoutManager$b;Ljava/io/File;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/provider/SplashProvider;->f(Landroid/content/Context;Lcom/android/camera/display/layout/CamLayoutManager$b;Ljava/io/File;)V

    return-void
.end method

.method private synthetic f(Landroid/content/Context;Lcom/android/camera/display/layout/CamLayoutManager$b;Ljava/io/File;)V
    .locals 4
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/camera/provider/SplashProvider;->e(Landroid/content/Context;Lcom/android/camera/display/layout/CamLayoutManager$b;)V
    ...
    invoke-static {p1, p2, v0, p3}, Lcom/android/camera/z5;->p4(Landroid/graphics/Bitmap;Ljava/lang/String;ILandroid/graphics/Bitmap$CompressFormat;)Z
    :try_end_0
...
# virtual methods
.method public final b(Lcom/android/camera/display/layout/CamLayoutManager$b;)Ljava/lang/String;
    .locals 2
...
.method public final c()Ljava/io/File;
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/android/camera/provider/SplashProvider;->d()Lcom/android/camera/display/layout/CamLayoutManager$b;
    ...
    invoke-virtual {p0, v1}, Lcom/android/camera/provider/SplashProvider;->b(Lcom/android/camera/display/layout/CamLayoutManager$b;)Ljava/lang/String;
    ...
    invoke-direct {v6, p0, v0, v1, v2}, Ld9/a;-><init>(Lcom/android/camera/provider/SplashProvider;Landroid/content/Context;Lcom/android/camera/display/layout/CamLayoutManager$b;Ljava/io/File;)V

    invoke-static {v3, v6}, Ldg/i;->r(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
...
.method public final d()Lcom/android/camera/display/layout/CamLayoutManager$b;
    .locals 1
    ...
    invoke-static {p0}, Lq7/y4;->b(I)Lcom/android/camera/module/entry/b;

    move-result-object p0

    invoke-interface {p0}, Lcom/android/camera/module/entry/b;->getModeUI()Ls6/l;

    move-result-object p0

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/android/camera/display/layout/i;->c(Ls6/l;Z)Lcom/android/camera/display/layout/CamLayoutManager$b;
...
.method public final e(Landroid/content/Context;Lcom/android/camera/display/layout/CamLayoutManager$b;)V
    .locals 7
