...
# static fields
.field public static final Z:Ljava/lang/String; = "SmartGuideFragment"


# instance fields
.field public K:Lmiuix/appcompat/app/AlertDialog;

.field public Y:Lm7/a$b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/settings/SmartGuideFragment;->Y:Lm7/a$b;

    return-void
.end method

.method public static synthetic pi(Lcom/android/camera/fragment/settings/SmartGuideFragment;)V
    .locals 0

    invoke-virtual {p0}, Lcom/android/camera/fragment/settings/SmartGuideFragment;->ti()V
...
.method public static synthetic qi()V
    ...
    invoke-static {}, Lcom/android/camera/fragment/settings/SmartGuideFragment;->ui()V

    return-void
.end method

.method public static synthetic ri(Lcom/android/camera/fragment/settings/SmartGuideFragment;Lmiuix/appcompat/app/AlertDialog;)Lmiuix/appcompat/app/AlertDialog;
    .locals 0

    iput-object p1, p0, Lcom/android/camera/fragment/settings/SmartGuideFragment;->K:Lmiuix/appcompat/app/AlertDialog;

    return-object p1
.end method

.method public static synthetic si(Lcom/android/camera/fragment/settings/SmartGuideFragment;)Lm7/a$b;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/fragment/settings/SmartGuideFragment;->Y:Lm7/a$b;
...
.method public onPreferenceClick(Landroidx/preference/Preference;)Z
    ...
    invoke-static {p1}, Lcom/android/camera/u2;->q5(Landroid/content/Context;)Z

    move-result p1

    if-nez p1, :cond_3

    iget-object p1, p0, Lcom/android/camera/fragment/settings/SmartGuideFragment;->K:Lmiuix/appcompat/app/AlertDialog;
    ...
    new-instance v5, Ly6/o;

    invoke-direct {v5, p0}, Ly6/o;-><init>(Lcom/android/camera/fragment/settings/SmartGuideFragment;)V
    ...
    new-instance v9, Ly6/p;

    invoke-direct {v9}, Ly6/p;-><init>()V
...
.method public final vi()V
    ...
    invoke-static {v2}, Lcom/android/camera/u2;->q5(Landroid/content/Context;)Z

    move-result v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->y:Lr8/a;

    invoke-virtual {v0}, Landroidx/preference/TwoStatePreference;->isChecked()Z

    move-result v3

    invoke-virtual {v2, v1, v3}, Lr8/a;->getBoolean(Ljava/lang/String;Z)Z
