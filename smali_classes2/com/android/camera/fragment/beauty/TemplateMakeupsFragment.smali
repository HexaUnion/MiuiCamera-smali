...
# static fields
.field public static final C2:Ljava/lang/String; = "TemplateMakeupsFragment"


# instance fields
.field public C1:I

.field public K0:Lcom/android/camera/fragment/beauty/TemplateMakeupsAdapter;
...
.field public k1:Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment$MyLayoutManager;

.field public p1:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->v1:Z
...
.method private sh()V
    ...
    iput v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->C1:I

    iget-object v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->p2:Ljava/util/List;
    ...
    iget v3, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->C1:I
    ...
    iput-boolean v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->q2:Z
    ...
    iput-boolean v2, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->q2:Z

    iget v2, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->C1:I

    iget v3, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->V1:I
    ...
    :goto_0
    iput v3, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->K1:I

    return-void
.end method

.method private ti(I)Z
    .locals 4

    iget-object v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k1:Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment$MyLayoutManager;
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k1:Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment$MyLayoutManager;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k1:Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment$MyLayoutManager;
...
.method public final Uh()Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->Nh()Ljava/lang/String;

    move-result-object p0

    const/4 v1, 0x0

    invoke-interface {v0, p0, v1}, Ly8/g;->Z2(Ljava/lang/String;Z)Ljava/util/List;
...
.method public di(Lcom/android/camera/data/data/j;)V
    .locals 0
...
.method public initView(Landroid/view/View;)V
    ...
    iget-boolean v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->v2:Z

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iput-boolean v1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->v2:Z
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k1:Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment$MyLayoutManager;

    invoke-virtual {p1, v1}, Landroidx/recyclerview/widget/LinearLayoutManager;->setOrientation(I)V

    iget-object p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k1:Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment$MyLayoutManager;

    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment$MyLayoutManager;->setScrollEnabled(Z)V

    iget-object p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->Uh()Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->p2:Ljava/util/List;

    invoke-direct {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->sh()V

    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->ri()Z
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->p2:Ljava/util/List;
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->K0:Lcom/android/camera/fragment/beauty/TemplateMakeupsAdapter;
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->Wh()Landroid/widget/AdapterView$OnItemClickListener;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->p1:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k0:Landroidx/recyclerview/widget/RecyclerView;
...
.method public notifyItemChanged(II)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->qi()Z
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_1
    iget-object v1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->K0:Lcom/android/camera/fragment/beauty/TemplateMakeupsAdapter;
    ...
    :cond_3
    iget-object p0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->K0:Lcom/android/camera/fragment/beauty/TemplateMakeupsAdapter;
...
.method public onItemSelected(IZ)V
    ...
    :cond_0
    iget v1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->q1:I

    iput p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->q1:I
    ...
    iget-object p2, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->p2:Ljava/util/List;

    iget v2, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->q1:I
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->p2:Ljava/util/List;

    iget v3, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->q1:I
    ...
    invoke-interface {v0, p1, p2, v2, v3}, Lv8/n1;->U0(Ljava/lang/String;Ljava/lang/String;IZ)V

    :cond_1
    iget p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->q1:I

    invoke-direct {p0, p1}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->ti(I)Z
...
.method public onResume()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->si()V
...
.method public onViewCreatedAndVisibleToUser(Z)V
    ...
    iget-boolean p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->v1:Z

    if-nez p1, :cond_0

    invoke-virtual {p0}, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->pi()I
    ...
    invoke-interface {v0, p0, v1, p1, v2}, Lv8/n1;->U0(Ljava/lang/String;Ljava/lang/String;IZ)V
...
.method public final pi()I
    ...
    invoke-static {v0}, Lcom/android/camera/u2;->m(I)Ljava/lang/String;
    ...
    :goto_1
    iget-object v3, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->p2:Ljava/util/List;
...
.method public provideRotateItem(Ljava/util/List;I)V
    ...
    iget-object p2, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->k1:Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment$MyLayoutManager;
...
.method public final qi()Z
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->p2:Ljava/util/List;
...
.method public ri()Z
    ...
    iget-boolean p0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->q2:Z
...
.method public setItemInCenter(I)V
    ...
    iget v0, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->C1:I

    div-int/lit8 v0, v0, 0x2

    iget v1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->K1:I
...
.method public setNoClip(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/fragment/beauty/TemplateMakeupsFragment;->v2:Z
