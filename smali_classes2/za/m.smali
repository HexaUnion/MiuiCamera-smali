...
.method public g1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-object v2, p0, Lza/m;->T:Landroid/view/Surface;

    if-eqz v2, :cond_3

    iget-object v2, p0, Lza/m;->U:Landroid/view/Surface;
    ...
    iget-object v4, v2, Lya/s5$b;->o:[I
    ...
    iget v4, v2, Lya/s5$b;->c:I

    iget v2, v2, Lya/s5$b;->u:I
    ...
    iget-object v5, v5, Lya/s5$b;->o:[I
    ...
    :goto_2
    invoke-virtual {p0, p1, p2}, Lza/m;->z1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
...
.method public o1()Lza/a$b;
    ...
    invoke-direct {v0, p0}, Lza/m$a;-><init>(Lza/m;)V
...
.method public p1()Lza/a$d;
    ...
    iget-boolean v6, v1, Lza/a$d;->c:Z
    ...
    invoke-virtual {v2, v7, v4}, Lya/j5;->s(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v7, v8, v4}, Lya/j5;->t(IZ)I
    ...
    invoke-virtual {v2}, Lya/c3;->v()Llb/d;

    move-result-object v2

    if-eqz v2, :cond_4

    invoke-virtual {v2}, Llb/d;->f()Z
    ...
    invoke-virtual {v2, v7, v4}, Lya/j5;->E(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v7, v4, v8}, Lya/j5;->F(ZI)I
    ...
    iput-object v2, p0, Lza/m;->T:Landroid/view/Surface;

    invoke-interface {v0, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v2, p0, Lza/a;->H:Lya/s5;

    invoke-virtual {v2}, Lya/s5;->a()Z
    ...
    iput-object v2, p0, Lza/m;->U:Landroid/view/Surface;
    ...
    iget-object v3, v3, Lya/s5$b;->f:Lfm/c;

    invoke-virtual {v3}, Lfm/c;->a()I
...
.method public z1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    .locals 2
