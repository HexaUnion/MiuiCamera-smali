...
.method public static synthetic P(Lc8/f;Landroid/hardware/camera2/CameraManager;[Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lc8/f;->T(Landroid/hardware/camera2/CameraManager;[Ljava/lang/String;)V

    return-void
.end method

.method private synthetic T(Landroid/hardware/camera2/CameraManager;[Ljava/lang/String;)V
    .locals 0

    invoke-virtual {p0, p1, p2}, Lc8/f;->S(Landroid/hardware/camera2/CameraManager;[Ljava/lang/String;)Landroid/util/SparseArray;

    invoke-virtual {p0}, Lc8/f;->Q()V
...
.method public declared-synchronized C()I
    ...
    :try_start_0
    invoke-virtual {p0}, Lc8/f;->isInitialized()Z
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lc8/f;->h:Landroid/util/SparseIntArray;
...
.method public final declared-synchronized Q()V
    ...
    :goto_0
    :try_start_1
    iget-object v2, p0, Lc8/f;->h:Landroid/util/SparseIntArray;
    ...
    iget-object v3, p0, Lc8/f;->h:Landroid/util/SparseIntArray;

    invoke-virtual {v3, v1}, Landroid/util/SparseIntArray;->valueAt(I)I

    move-result v3

    iget-object v4, p0, Lc8/c;->b:Landroid/util/SparseArray;
    ...
    invoke-static {v4}, Lya/g;->r0(Lya/f;)Ljava/util/Set;

    move-result-object v4

    iget-object v6, p0, Lc8/c;->b:Landroid/util/SparseArray;
    ...
    invoke-static {v6, v0}, Lya/g;->M1(Lya/f;Z)F
...
.method public final S(Landroid/hardware/camera2/CameraManager;[Ljava/lang/String;)Landroid/util/SparseArray;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_2
    invoke-virtual {p0, v5, p1}, Lc8/c;->O(ILandroid/hardware/camera2/CameraManager;)Lya/f;
    :try_end_2
    ...
    iget-object p0, p0, Lc8/c;->b:Landroid/util/SparseArray;
    :try_end_6
    ...
    invoke-virtual {p0}, Lc8/f;->reset()V
...
.method public declared-synchronized getCapabilities()Landroid/util/SparseArray;
    ...
    iget-object v0, p0, Lc8/c;->b:Landroid/util/SparseArray;
    :try_end_2
...
.method public isInitialized()Z
    ...
    iget-object p0, p0, Lc8/f;->h:Landroid/util/SparseIntArray;
...
.method public l(Landroid/hardware/camera2/CameraManager;)V
    ...
    iput-object v1, p0, Lc8/c;->b:Landroid/util/SparseArray;
    ...
    iput-object v1, p0, Lc8/f;->h:Landroid/util/SparseIntArray;
    ...
    sget-object v6, Lkb/r7;->z0:Lkb/kp;

    invoke-static {v4, v6}, Lkb/lp;->j(Landroid/hardware/camera2/CameraCharacteristics;Lkb/kp;)Ljava/lang/Object;
    ...
    iget-object v9, p0, Lc8/f;->h:Landroid/util/SparseIntArray;
    ...
    :cond_0
    sget-object v6, Lkb/r7;->x0:Lkb/kp;

    invoke-static {v4, v6}, Lkb/lp;->a(Landroid/hardware/camera2/CameraCharacteristics;Lkb/kp;)Ljava/lang/Object;
    ...
    :goto_2
    iget-object v6, p0, Lc8/f;->h:Landroid/util/SparseIntArray;
    ...
    invoke-direct {v3, p0, p1, v0}, Lc8/e;-><init>(Lc8/f;Landroid/hardware/camera2/CameraManager;[Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0, v1}, Lcom/android/camera/s3$b;->S(Ljava/lang/String;Ljava/lang/String;)V
...
.method public declared-synchronized reset()V
    ...
    iput-object v0, p0, Lc8/f;->h:Landroid/util/SparseIntArray;

    iput-object v0, p0, Lc8/c;->b:Landroid/util/SparseArray;

    iput-boolean v2, p0, Lc8/c;->d:Z
...
.method public declared-synchronized x()[I
    ...
    iget-object v1, p0, Lc8/f;->h:Landroid/util/SparseIntArray;
